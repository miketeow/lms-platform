...
import { checkIfUserIsEnrolled } from "@/app/data/user/user-is-enrolled";
...
export default async function SlugPage({ params }: { params: Params }) {
  ...
  const thumbnailUrl = constructS3Url(course.fileKey);
  const isEnrolled = await checkIfUserIsEnrolled(course.id);
  return (
                    ...
                    <div className="border-t bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lessons.map((lesson, lessonIndex) => (
                          ...
                          >
                            <div className="flex size-8 items-center justify-center rounded-full border-2 bg-background border-primary/20">
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Full time life access</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full p-1 bg-green-500/10 text-green-500">
                      <CheckIcon className="size-3" />
